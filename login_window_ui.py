...
#
# Created: Thu Jan 15 00:51:49 2015
...
class Ui_LoginWindow(object):
    def setupUi(self, LoginWindow):
        ...
        LoginWindow.resize(241, 223)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(LoginWindow.sizePolicy().hasHeightForWidth())
        LoginWindow.setSizePolicy(sizePolicy)
        LoginWindow.setMaximumSize(QtCore.QSize(241, 223))
        LoginWindow.setBaseSize(QtCore.QSize(241, 223))
        ...
        self.line_password.setInputMethodHints(QtCore.Qt.ImhHiddenText)
        ...
        self.login_button = QtGui.QPushButton(self.login_box)
        self.login_button.setGeometry(QtCore.QRect(20, 110, 81, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(False)
        font.setWeight(50)
